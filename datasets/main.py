#DONT RUN THIS CODE, IT IS A TEMPLATE FOR THE DATASET CLEANING PROCESS NOT UPDATED CODE
#WARNING
#ASTHA SAID "DON'T RUN THIS CODE", IT HAS BEEN UPDATED IF NEED CREATE OWN .PY FILE
import os
import cv2
import shutil
